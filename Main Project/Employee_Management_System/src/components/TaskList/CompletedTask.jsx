...
function CompletedTask({ data ,key}) {


  

     return (
        <div key={key} className="flex-shrink-0 h-full w-[300px] bg-green-400 rounded-xl p-5">
            ...
            <div className='flex justify-between mt-4'>
                <button     className='bg-green-500 px-1 py-2 text-sm w-full'>Completed</button>
            </div>
        </div>)
}
